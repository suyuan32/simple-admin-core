...
func (tu *TenantUpdate) SetParentID(u uuid.UUID) *TenantUpdate {
	tu.mutation.SetParentID(u)
	return tu
}

// SetNillableParentID sets the "parent_id" field if the given value is not nil.
func (tu *TenantUpdate) SetNillableParentID(u *uuid.UUID) *TenantUpdate {
	if u != nil {
		tu.SetParentID(*u)
	}
	return tu
...
// SetParentID sets the "parent_id" field.
func (tuo *TenantUpdateOne) SetParentID(u uuid.UUID) *TenantUpdateOne {
	tuo.mutation.SetParentID(u)
	return tuo
}

// SetNillableParentID sets the "parent_id" field if the given value is not nil.
func (tuo *TenantUpdateOne) SetNillableParentID(u *uuid.UUID) *TenantUpdateOne {
	if u != nil {
		tuo.SetParentID(*u)
	}
	return tuo
