...
func HasMember() predicate.MemberRank {
	return predicate.MemberRank(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, true, MemberTable, MemberColumn),
		)
...
func HasMemberWith(preds ...predicate.Member) predicate.MemberRank {
	return predicate.MemberRank(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
