...
func (tc *TenantCreate) SetUUID(s string) *TenantCreate {
	tc.mutation.SetUUID(s)
	return tc
}

// SetNillableUUID sets the "uuid" field if the given value is not nil.
func (tc *TenantCreate) SetNillableUUID(s *string) *TenantCreate {
	if s != nil {
		tc.SetUUID(*s)
	}
	return tc
...
func (tc *TenantCreate) SetAccount(s string) *TenantCreate {
	tc.mutation.SetAccount(s)
	return tc
}
...
func (tc *TenantCreate) AddUserIDs(ids ...uint64) *TenantCreate {
...
func (tc *TenantCreate) SetNillableParentID(id *uint64) *TenantCreate {
	if id != nil {
...
func (tc *TenantCreate) check() error {
	...
	if _, ok := tc.mutation.Account(); !ok {
		return &ValidationError{Name: "account", err: errors.New(`ent: missing required field "Tenant.account"`)}
	}
	if _, ok := tc.mutation.StartTime(); !ok {
...
func (tc *TenantCreate) createSpec() (*Tenant, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.Account(); ok {
