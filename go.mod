...
replace github.com/zeromicro/go-zero v1.4.2 => github.com/suyuan32/simple-admin-tools v0.0.8-0.20221027225837-20bc8d8f4939
...
require (
	...
	github.com/suyuan32/simple-models v0.0.2 // indirect
