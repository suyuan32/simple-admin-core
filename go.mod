...
require (
	...
	github.com/suyuan32/simple-admin-job v1.5.6
	github.com/suyuan32/simple-admin-message-center v1.5.6
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.1015 // indirect
