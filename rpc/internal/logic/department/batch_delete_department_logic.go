...
func NewBatchDeleteDepartmentLogic(ctx context.Context, svcCtx *svc.ServiceContext) *BatchDeleteDepartmentLogic {
...
func (l *BatchDeleteDepartmentLogic) BatchDeleteDepartment(in *core.IDsReq) (*core.BaseResp, error) {
