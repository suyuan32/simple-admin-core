...
func (l *InitDatabaseLogic) insertApiData() error {
	...
	apis = append(apis, l.svcCtx.DB.API.Create().
		SetPath("/member/create").
		SetDescription("apiDesc.createMember").
		SetAPIGroup("member").
		SetMethod("POST"),
	)

	apis = append(apis, l.svcCtx.DB.API.Create().
		SetPath("/member/update").
		SetDescription("apiDesc.updateMember").
		SetAPIGroup("member").
		SetMethod("POST"),
	)
	...
	apis = append(apis, l.svcCtx.DB.API.Create().
		SetPath("/member").
		SetDescription("apiDesc.getMemberById").
		SetAPIGroup("member").
		SetMethod("Post"),
	)
	...
	apis = append(apis, l.svcCtx.DB.API.Create().
		SetPath("/member_rank/create").
		SetDescription("apiDesc.createMemberRank").
		SetAPIGroup("member_rank").
		SetMethod("POST"),
	)

	apis = append(apis, l.svcCtx.DB.API.Create().
		SetPath("/member_rank/update").
		SetDescription("apiDesc.updateMemberRank").
		SetAPIGroup("member_rank").
		SetMethod("POST"),
	)
	...
	apis = append(apis, l.svcCtx.DB.API.Create().
		SetPath("/member_rank").
		SetDescription("apiDesc.getMemberRankById").
		SetAPIGroup("member_rank").
		SetMethod("Post"),
	)
