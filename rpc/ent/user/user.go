...
func ByHomePath(opts ...sql.OrderTermOption) Order {
...
func ByDepartmentID(opts ...sql.OrderTermOption) Order {
	return sql.OrderByField(FieldDepartmentID, opts...).ToFunc()
}

// ByDepartmentsField orders the results by departments field.
func ByDepartmentsField(field string, opts ...sql.OrderTermOption) Order {
