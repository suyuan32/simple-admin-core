...
type UserInfo struct {
	...
	ExpiredAt      *int64                 `protobuf:"varint,19,opt,name=expired_at,json=expiredAt,proto3,oneof" json:"expired_at,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *UserListReq) GetExpiredAt() int64 {
	if x != nil && x.ExpiredAt != nil {
		return *x.ExpiredAt
	}
	return 0
...
const file_rpc_core_proto_rawDesc = "" +
	...
	"\n" +
	"expired_at\x18\x13 \x01(\x03H\x0eR\texpiredAt\x88\x01\x01B\x05\n" +
	"\x03_idB\r\n" +
	"\v_created_atB\r\n" +
	"\v_updated_atB\t\n" +
	"\a_statusB\v\n" +
	...
	"\n" +
	"expired_at\x18\v \x01(\x03H\x06R\texpiredAt\x88\x01\x01B\v\n" +
	"\t_usernameB\v\n" +
	"\t_nicknameB\b\n" +
	"\x06_emailB\t\n" +
	"\a_mobileB\x10\n" +
