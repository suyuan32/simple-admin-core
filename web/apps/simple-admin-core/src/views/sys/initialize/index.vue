    ...
    <Row :gutter="[16, 16]">
      <Col :span="6">
        <Card :hoverable="true" :title="$t('sys.init.initCoreDatabase')">
          <Button
            class="w-full"
            href="https://github.com/chimerakang/simple-admin-core"
            type="link"
          >
            Core Github
          </Button>
      ...
      <Col :span="6">
        <Card :hoverable="true" :title="$t('sys.init.initFileDatabase')">
          <Button
            class="w-full"
            href="https://github.com/chimerakang/simple-admin-file"
            type="link"
          >
            File Manager Github
          </Button>
      ...
      <Col :span="6">
        <Card :hoverable="true" :title="$t('sys.init.initMMSDatabase')">
          <Button
            class="w-full"
            href="https://github.com/chimerakang/simple-admin-member-api"
            type="link"
          >
            Member Github
          </Button>
      ...
      <Col :span="6">
        <Card :hoverable="true" :title="$t('sys.init.initJobDatabase')">
          <Button
            class="w-full"
            href="https://github.com/chimerakang/simple-admin-job"
            type="link"
          >
            Job Github
          </Button>
      ...
      <Col :span="6">
        <Card :hoverable="true" :title="$t('sys.init.initMcmsDatabase')">
          <Button
            class="w-full"
            href="https://github.com/chimerakang/simple-admin-message-center"
            type="link"
          >
            Mcms Github
          </Button>
