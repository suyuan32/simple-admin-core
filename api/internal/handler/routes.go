...
import (
	...
	inventory "github.com/suyuan32/simple-admin-core/api/internal/handler/inventory"
	...
	product "github.com/suyuan32/simple-admin-core/api/internal/handler/product"
	...
	stock_movement "github.com/suyuan32/simple-admin-core/api/internal/handler/stock_movement"
	...
	warehouse "github.com/suyuan32/simple-admin-core/api/internal/handler/warehouse"
		...
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				},
				{
					...
					Handler: warehouse.DeleteWarehouseHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/warehouse/list",
				...
				},
				{
					Method:  http.MethodPost,
					Path:    "/warehouse",
					Handler: warehouse.GetWarehouseByIdHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
		...
		rest.WithMiddlewares(
			...
			[]rest.Route{
				...
				},
				{
					...
					Handler: inventory.UpdateInventoryHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/inventory/delete",
					Handler: inventory.DeleteInventoryHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/inventory/list",
				...
				},
				{
					Method:  http.MethodPost,
					Path:    "/inventory",
					Handler: inventory.GetInventoryByIdHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
			...
			[]rest.Route{
				{
					...
					Handler: stock_movement.CreateStockMovementHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/stock_movement/update",
					Handler: stock_movement.UpdateStockMovementHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/stock_movement/delete",
					Handler: stock_movement.DeleteStockMovementHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/stock_movement/list",
					Handler: stock_movement.GetStockMovementListHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/stock_movement",
					Handler: stock_movement.GetStockMovementByIdHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
